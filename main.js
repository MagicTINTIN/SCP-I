...
/*
 * ANSWERING QUESTIONS
 * You can type jeReponds(35, 5000, [3]) to send 35 answer 3 in 5 seconds
 * If you want to answer multiple answer like 1 and 3, just type jeReponds(35, 5000, [1,3])
 *
 *
 * I'M LOST BUTTON
 * You can just type jeSuisPerdu(10, 4500) to send 10 times "Je suis perdu" in 4,5 seconds
 * If you want you can use fctPerdu(Math.sin,10,0.8,5, 30) to create a beautiful wave of lost students between 5 and 15 students each minute during 30 minutes
 * 
